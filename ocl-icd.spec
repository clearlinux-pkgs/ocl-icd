...
Version  : 2.2.14
Release  : 15
URL      : https://github.com/OCL-dev/ocl-icd/archive/v2.2.14/ocl-icd-2.2.14.tar.gz
Source0  : https://github.com/OCL-dev/ocl-icd/archive/v2.2.14/ocl-icd-2.2.14.tar.gz
...
%prep
%setup -q -n ocl-icd-2.2.14
cd %{_builddir}/ocl-icd-2.2.14
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610057668
...
cp %{_builddir}/ocl-icd-2.2.14/COPYING %{buildroot}/usr/share/package-licenses/ocl-icd/6e27f34439f0059927381892f5dc3e19605a4776
%make_install
