...
Source0  : https://github.com/OCL-dev/ocl-icd/archive/v2.2.13/ocl-icd-2.2.13.tar.gz
...
%prep
%setup -q -n ocl-icd-2.2.13
cd %{_builddir}/ocl-icd-2.2.13
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1602201956
...
cp %{_builddir}/ocl-icd-2.2.13/COPYING %{buildroot}/usr/share/package-licenses/ocl-icd/6e27f34439f0059927381892f5dc3e19605a4776
%make_install
